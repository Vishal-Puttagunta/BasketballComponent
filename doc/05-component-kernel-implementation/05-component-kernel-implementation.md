...
- **Due Date**: 11/21/2025 @ 4:10 PM EST
...
I will represent the state of my component using a Map<String, Integer> as each key would be set to a book title and each value would represent the number of copies that are available of that book.
